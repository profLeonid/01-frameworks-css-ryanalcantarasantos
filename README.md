...
1. Crie seu projeto
    ...
    Comece criando um novo projeto Vite, caso ainda não tenha um configurado. A abordagem mais comum é usar a opção Criar Vite .
...
2. Instale o Tailwind CSS
    ...
    Instale tailwindcssvia @tailwindcss/vitenpm.

comandos:

`npm install tailwindcss @tailwindcss/vite`

3. Configure o plugin Vite

      Adicione o @tailwindcss/viteplugin à sua configuração do Vite

<img width="570" height="229" alt="image" src="https://github.com/user-attachments/assets/8913e214-d6fe-4145-82c4-1a54e4263078" />

4. Importar CSS do Tailwind

       Adicione um elemento @importao seu arquivo CSS que importe o Tailwind CSS.

   `@import "tailwindcss";`

6. Comece a usar o Tailwind no seu HTML.

   Certifique-se de que seu CSS compilado esteja incluído no arquivo `package.json` <head> (seu framework pode cuidar disso para você) e, em seguida, comece a usar as classes utilitárias do Tailwind para estilizar seu conteúdo.
   <img width="566" height="342" alt="image" src="https://github.com/user-attachments/assets/3d53ae3a-7834-44c7-873c-37c3393bd5c5" />
